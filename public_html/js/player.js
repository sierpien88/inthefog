var audioPlayer = function () {
    ...
    var initPlayer = function () {
        ...
        for (var i = 0; i < _elements.playListRows.length; i++) {
            ...
            var playListLink =
                _elements.playListRows[i].children[2].children[0];
            ...
            playListLink.addEventListener(
                ...
                function (e) {
                    ...
                    var selectedTrack = parseInt(
                        this.parentNode.parentNode.getAttribute(
                            "data-track-row"
                        )
                    );
    ...
    var _updateProgressIndicator = function () {
        ...
        var progressBarIndicatorWidth =
            progressBarWidth - progressIndicatorWidth;

        indicatorLocation =
            progressBarIndicatorWidth * (currentTime / duration);
