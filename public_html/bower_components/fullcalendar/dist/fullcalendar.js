                ...
                TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
                    ...
                    return '<a class="' + classes.join(' ') + '"' +
                        ...
                        (eventDef.title ?
                            ...
                            '') +
                        '</div>' +
                        '<div class="fc-bg event-details" data-id="' + util_1.htmlEscape(eventDef.id) + '"/>' +
                ...
                DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
                    ...
                    return '<a class="' + classes.join(' ') + '"' +
                        ...
                        (skinCss ?
                            ...
                            '') +
                        '>' +
                        '<div class="fc-content event-details" data-id="' + util_1.htmlEscape(eventDef.id) + '" >' +
                        (this.dayGrid.isRTL ?
            ...
            var ListEventRenderer = /** @class */ (function (_super) {
                ...
                ListEventRenderer.prototype.fgSegHtml = function (seg) {
                    ...
                    return '<tr class="' + classes.join(' ') + '">' +
                        ...
                        '<a' + (url ? ' href="' + util_1.htmlEscape(url) + '"' : '') + ' class="event-details" data-id="' + util_1.htmlEscape(eventDef.id) + '">' +
                        util_1.htmlEscape(eventDef.title || '') +
                        '</a>' +
                        '<a style="float:right" class="btn btn-danger for-admin" onclick="deleteEvent(' + util_1.htmlEscape(eventDef.id) + ')">Usuń to spotkanie' +
                        '</a>' +
                        '<a style="float:right" class="btn btn-primary for-admin" onclick="showEditForm(' + util_1.htmlEscape(eventDef.id) + ')">Edytuj to spotkanie' +
                        '</a>' +
                        '</td>' +
                        '</tr>';
                };
