                                            ...
                                            <div class="col-lg-6">
                                                <h4><?php echo $lang['tracklist']; ?>:<< /h4>
                                                        <ul class="cd-track-list">
                                                            ...
                                                            <li>This is Pripyat
                                                                <audio src="mix/ITF_2/2_This_is_Pripyat.mp3" controls
                                                                    loop class="hidden" class="hidden-player"></audio>
                                                            </li>
                                                            <li>Down is Fine
                                                            ...
                                                            <li>Coming Back Home
                                                                <audio src="mix/ITF_2/5_Coming_Back_Home.mp3" controls
                                                                    loop class="hidden" class="hidden-player"></audio>
                                                            </li>
                                                            <li>Fragile Hearts
                                                                <audio src="mix/ITF_2/6_Fragile_Hearts.mp3" controls
                                                                    loop class="hidden" class="hidden-player"></audio>
                                                            </li>
                                                            <li>No Rewind
